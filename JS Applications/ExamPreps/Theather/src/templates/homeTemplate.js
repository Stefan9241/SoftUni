...
import { getAllTheathers } from "../restFunctions.js";
let homeTemplate = (thethers) => html` <section class="welcomePage">
  ...
  <div id="events">
    ...
    <div class="theaters-container">
      <!--Created Events-->
      ${thethers && thethers.length !== 0
        ? thethers.map(oneItemCard)
...
let oneItemCard = (item) => html` <div class="eventsInfo">
...
export async function homeRoute(ctx) {
  let items = await getAllTheathers();
  return ctx.render(homeTemplate(items));
}
