...
describe('E2E tests', function () {
    ...
    describe('Search Page [ 10 Points ]', async () => {
        ...
        it.only('Show no matches for Guest [ 1 Points ]', async () => {
        ...
        it.only('Show results with 2 albums for Guest [ 2 Points ]', async () => {
        ...
        it.only('No Details button for Guest [ 2 Points ]', async () => {
            const { get } = await handle(endpoints.search('Name'));
        ...
        it.only('Show results with 2 albums for Users [ 2 Points ]', async () => {
            // Login user
            const data = mockData.users[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('Show Details button for User [ 2 Points ]', async () => {
            // Login user
            const data = mockData.users[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
